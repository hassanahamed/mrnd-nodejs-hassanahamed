...
var getContactFileName = function(id) {
	...
	return "C:/Users/Hassan/Desktop/mrnd-nodejs-master (1)/mrnd-nodejs-master/src/contacts/data//" + id + "-Contact.json";
}
var idCreated;
describe("FilePersistence Test Suite", function(){

	//var request = require('request');
	var request = require('C:/Program Files (x86)/nodejs/node_modules/npm/node_modules/request')
	...
	describe("post and get message to contact", function(){
		...
		it("should post message to contact", function(done){
			...
			var updatedContact = new Object();
			updatedContact.message = "jagan-updated";
			request.put({
							url: contacts_url + "/" + idCreated,
							body: updatedContact,
							json: true
		    		    ...
		    		    function(error, response, body){
							...
							var obj = JSON.parse(fs.readFileSync(fileName));
							expect(obj.message).toBe("jagan-updated");
							done();
